...
export default class App extends Component {
  pageSize=9;
  // apiKey="f94b2ed5069a4c1f836f85cc2d6df67a";
  state={
    progress:0
  }
    ...
    return (
      <div>
        ...
        <Routes>
          ...
          <Route exact path="/technology" element={<News setProgress={this.setProgress}  key="" pageSize={this.pageSize} country="in" category="technology"/>}></Route>
        </Routes>
        </Router>
      </div>
    )
...
//f94b2ed5069a4c1f836f85cc2d6df67a    API-KEY